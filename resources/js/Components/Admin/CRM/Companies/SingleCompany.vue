                ...
                <div class="flex items-center space-x-5">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-500">
                            First contacted on
                            <time datetime="{{ company.created_at }}">{{ company.created_at }}</time>
                        </p>
                         <p class="text-sm font-medium text-gray-500">
                            Last contacted on
                            <time datetime="{{ company.updated_at }}">{{ company.updated_at }}</time>
                        </p>
                    </div>
                </div>
                <div
...
import NoNotes from "@/Components/Admin/CRM/Companies/NoNotes.vue";
...
export default {
    ...
    methods: {
        addNote() {
            this.$inertia.post(
                `/admin/crm/companies/${this.company.slug}/notes`,
                this.form
            );
            this.form.note = "";
        },
        deleteCompany() { 
            this.$inertia.delete(`/admin/crm/companies/${this.company.slug}`);
        }
    },
};
</script>
